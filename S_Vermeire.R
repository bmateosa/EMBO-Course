############ Public transcriptomics from S. Vermeire paper
library(DESeq2)
library(biomaRt)
...
######### Deleting data I am not interested in
...
######### Preparing COLData with the type of samples I have (CD + control)
...
listAttributes(mart)  ### list of info you can ask for
