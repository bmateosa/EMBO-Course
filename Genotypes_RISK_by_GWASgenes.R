...
#######  heterocygous patients to these genes and homocygous with high risk or homocygous with no risk.
####### We use to methods to select SNPs: Top CS2G and the closest SNP to the gene.
###### Genotypes and expression was analyzed from the cohort RISK
